                ...
                renderItem={({ item }) => (
                    <Card style={styles.card}>
                        <Card.Content>
                            ...
                            <Text style={styles.cardDetail}>{item.tier} Tier</Text>
                            <Text style={styles.cardDetail}>Prereq: {item.prerequisite}</Text>
                            <Text style={styles.cardDetail}>{item.benefit}</Text>
                        </Card.Content>
                    </Card>
                )}
            />
